...
{$principalContactSignature}',
  ...
  'emails.passwordReset.subject' => 'Password modificata',
  'emails.passwordReset.body' => 'La tua password per {$siteTitle} è stata modificata con successo.<br />
...
<br />
{$principalContactSignature}',
  'emails.passwordReset.description' => 'Questa email viene mandata ad un utente registrato quando ha resettato la password seguendo il processo descritto nella email PASSWORD_RESETTA_CONFERMA.',
...
{$editorialContactSignature}',
  ...
  'emails.submissionUnsuitable.body' => 'Gentilissimo {$authorName}:<br />
<br />
...
<br />
{$editorialContactSignature}',
  'emails.submissionUnsuitable.description' => 'Questa email viene inviata quando una proposta viene ritenuta non idonea per la rivista.',
...
<br />
{$comments}',
  'emails.submissionComment.description' => 'Questa email notifica a varie persone coinvolte nel processo editoriale di una submission  che è stato aggiunto un nuovo commento.',
  'emails.submissionDecisionReviewers.subject' => 'Decisione su "{$submissionTitle}"',
  'emails.submissionDecisionReviewers.body' => 'Gentile revisore di {$contextName},<br />
...
======<br />
{$comments}',
  'emails.submissionDecisionReviewers.description' => 'Questa email notifica ai revisori di una submission che il processo di revisione è stato completato. Include informazioni sull\'articolo e le decisioni raggiunte, e ringrazia i revisori per i loro contributi.',
...
<br />
{$editorialContactSignature}',
  'emails.layoutAck.description' => 'Questa email dal section editor al layout editor riconosce il completamento del processo di layout e ringrazia il curatore di layout per il contributo.',
...
<br />
{$editorialContactSignature}',
  'emails.proofreadAuthorRequest.description' => 'Questa mail viene inviata dall\'editor all\'autore per informarlo che è necessario correggere le bozze del suo contributo. Fornisce informazioni sulla procedura.',
...
{$authorName}',
  'emails.proofreadAuthorComplete.description' => '',
...
<br />
{$editorialContactSignature}',
  'emails.proofreadAuthorAck.description' => 'Questa email dal section editor all\'autore riconosce il completamento del processo iniziale di correzione di bozze e ringrazia per il contributo.',
  'emails.proofreadRequest.subject' => 'Richiesta correzione di bozze',
  'emails.proofreadRequest.body' => 'Gentile {$proofreaderName},<br />
<br />
...
{$editorialContactSignature}',
  'emails.proofreadRequest.description' => 'Questa email dal section editor al correttore di bozze richiede che facciano la correzione delle bozze di un articolo. Fornisce informazioni sull\'articolo e su come accedervi.',
...
<br />
{$proofreaderName}',
  'emails.proofreadComplete.description' => 'Questa email dal correttore di bozze al section editor notifica che il correttore di bozze ha completato il processo di correzione.',
...
<br />
{$editorialContactSignature}',
  'emails.proofreadAck.description' => 'Questa email dal section editor al correttore di bozze conferma il completamento del processo di correzione do bozze e ringrazia per il contributo.',
...
<br />
{$participantName}',
  'emails.proofreadLayoutComplete.description' => 'Questa email dal curatore del layout informa che la fase finale di correzione delle bozze è stata completata e l\'articolo è pronto per essere pubblicato.',
...
<br />
{$editorialContactSignature}',
  'emails.proofreadLayoutAck.description' => 'Questa email dal section editor al layout editor riconosce il completamento della fase finale della correzione delle bozze e ringrazia per il contributo.',
...
{$principalContactSignature}',
  ...
  'emails.notificationMaillist.body' => 'Hai ricevuto una notifica da  {$siteTitle}:<br />
--<br />
{$notificationContents}<br />
<br />
Link: {$url}<br />
...
<br />
{$principalContactSignature}',
  'emails.notificationMaillist.description' => 'Questa mail è inviata agli utenti non registrati alla lista di notifiche.',
  'emails.notificationMaillistWelcome.subject' => 'Benvenuto nella mailing list di {$siteTitle}!',
  'emails.notificationMaillistWelcome.body' => 'Hai chiesto di ricevere notifiche da {$siteTitle}.<br />
<br />
...
<br />
{$principalContactSignature}',
  'emails.notificationMaillistWelcome.description' => 'Questo messaggio viene inviato a utenti che si sono appena registrati per ricevere le notifiche.',
